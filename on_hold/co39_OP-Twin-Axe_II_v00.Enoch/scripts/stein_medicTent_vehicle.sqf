...
stein_BuildTime = 20;
stein_medicTent = "Land_MedicalTent_01_wdl_generic_open_F";
//stein_medicTent = "Land_tent_east";

stein_SupportedVehicleClasses = ["I_E_Truck_02_Medical_F"];

//stein_tent_items = ["Land_Defibrillator_F","Land_Camping_Light_F", "Land_FirstAidKit_01_open_F"];
stein_tent_items = ["Land_MedicalTent_01_floor_light_F"];
...
stein_fnc_deconstructTent = {
	...
	private _arrayItems = nearestObjects [(getPos _target), stein_tent_items, 10];
	{
		deleteVehicle _x;
	} forEach _arrayItems;
...
stein_fnc_buildTent = {
	...
	_medicTent animateSource ["MedSign_Hide",0,true];
