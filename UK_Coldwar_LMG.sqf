...
comment "Add weapons";
player addWeapon "UK3CB_Bren";
player addPrimaryWeaponItem "UK3CB_Bren_30Rnd_762x51_Magazine";
...
for "_i" from 1 to 3 do {player addItemToUniform "UK3CB_Bren_30Rnd_762x51_Magazine";};
