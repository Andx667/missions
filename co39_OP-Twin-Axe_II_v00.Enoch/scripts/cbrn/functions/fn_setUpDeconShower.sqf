...
//TODO Wasserstand erhöhen
if (local _shower) then {
    _shower setVariable ["cbrn_water", 1200, true];
};
...
private _action = ["cbrn_turn_on", "Dusche Anschalten","",{
    ...
    private _remainingWater = _target getVariable ["cbrn_water", 1200];
    ...
    !(_target getVariable ["cbrn_on", false]) && {(_target getVariable ["cbrn_water", 1200]) > 0}
...
_action = ["cbrn_turn_off", "Dusche Ausschalten","",{
