...
_action = ["cbrn_turn_check_damage", "Check CRBN Exposure","",{
    ...
    if (_coef < 0.1) exitWith {
        titleText ["Du fühlst dich <t color='#00ff00'>gut</t>!" , "PLAIN DOWN", -1, false, true];
    };
    if (_coef < 0.5) exitWith {
        titleText ["Du fühlst dich <t color='#ffff00'>angeschlagen</t>! Das Atmen fällt dir schwer..." , "PLAIN DOWN", -1, false, true];
    };
    if (_coef >= 0.5) exitWith {
        titleText ["Du fühlst dich <t color='#ff7b00'>schlecht</t>! Du bekommst kaum noch Luft, deine Haut brennt..." , "PLAIN DOWN", -1, false, true];
    };
