...
player addItemToBackpack "UK3CB_BAF_H_Mk7_Net_A";
for "_i" from 1 to 8 do {player addItemToBackpack "UK3CB_BAF_556_30Rnd_T";};
...
for "_i" from 1 to 2 do {player addItemToBackpack "UK3CB_BAF_SmokeShellOrange";};
for "_i" from 1 to 2 do {player addItemToBackpack "UK3CB_BAF_SmokeShellPurple";};
for "_i" from 1 to 2 do {player addItemToBackpack "UK3CB_BAF_SmokeShellYellow";};
for "_i" from 1 to 2 do {player addItemToBackpack "UK3CB_BAF_SmokeShellRed";};
for "_i" from 1 to 2 do {player addItemToBackpack "UK3CB_BAF_SmokeShellBlue";};
