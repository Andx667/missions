...
for "_i" from 1 to 5 do {player addItemToVest "UK3CB_BAF_1Rnd_HEDP_Grenade_Shell";};
...
for "_i" from 1 to 5 do {player addItemToBackpack "UK3CB_BAF_1Rnd_HEDP_Grenade_Shell";};
