...
for "_i" from 1 to 10 do {player addItemToBackpack "ACE_morphine";};			//5stk
for "_i" from 1 to 10 do {player addItemToBackpack "ACE_quikclot";};
for "_i" from 1 to 4 do {player addItemToBackpack "ACE_tourniquet";};
for "_i" from 1 to 10 do {player addItemToBackpack "ACE_epinephrine";};			//10stk
for "_i" from 1 to 10 do {player addItemToBackpack "ACE_adenosine";};			//5stk
...
player setVariable ["ace_medical_medicClass",1,true]; //1 = Sani 2 = Arzt
