...
player addVest selectRandom ["UK3CB_BAF_V_Osprey_Rifleman_A","UK3CB_BAF_V_Osprey_Rifleman_C","UK3CB_BAF_V_Osprey_Rifleman_D","UK3CB_BAF_V_Osprey_Rifleman_E"];
player addBackpack "UK3CB_BAF_B_Bergen_MTP_Rifleman_XL_A";
...
for "_i" from 1 to 8 do {player addItemToBackpack "UK3CB_BAF_1Rnd_60mm_Mo_Shells";};
for "_i" from 1 to 8 do {player addItemToBackpack "UK3CB_BAF_1Rnd_60mm_Mo_AB_Shells";};
