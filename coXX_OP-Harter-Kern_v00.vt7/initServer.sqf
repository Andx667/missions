setDate [2035, 6, 12, 7, 30];						//Jahr, Monat, Tag, Stunde, Minute wird bei Missionsstart gesetzt (so kann man eine Nachtmission bei hellen 1200 Uhr bearbeiten ohne ständigen wechsel)
...
],14] call Fett_Redd_fnc_FuelConsumption;//14 too much for RHS