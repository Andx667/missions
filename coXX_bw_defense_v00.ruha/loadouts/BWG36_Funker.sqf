...
for "_i" from 1 to 3 do {player addItemToBackpack "Chemlight_yellow";};
for "_i" from 1 to 3 do {player addItemToBackpack "Chemlight_blue";};
for "_i" from 1 to 3 do {player addItemToBackpack "Chemlight_red";};
