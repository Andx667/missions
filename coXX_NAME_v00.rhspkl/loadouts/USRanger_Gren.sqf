...
player addVest "rhsusf_plateframe_grenadier";
...
for "_i" from 1 to 5 do {player addItemToVest "rhs_mag_30Rnd_556x45_M855A1_EPM_Ranger";};
player addItemToVest "rhs_mag_m67";
player addItemToVest "rhs_mag_mk84";
for "_i" from 1 to 2 do {player addItemToVest "SmokeShell";};
player addItemToVest "SmokeShellGreen";
for "_i" from 1 to 14 do {player addItemToVest "rhs_mag_M433_HEDP";};
for "_i" from 1 to 6 do {player addItemToBackpack "rhs_mag_30Rnd_556x45_M855A1_EPM_Ranger";};
