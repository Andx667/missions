...
for "_i" from 1 to 3 do {player addItemToBackpack "BWA3_1Rnd_Flare_Multistar_Red";};
for "_i" from 1 to 3 do {player addItemToBackpack "BWA3_1Rnd_Flare_Multistar_Green";};
for "_i" from 1 to 3 do {player addItemToBackpack "BWA3_1Rnd_Flare_Multistar_White";};
